<?php
/**
 * Application requirement checker scripts.
 *
 * In order to run this scripts use the following console command:
 * php requirements.php
 *
 * In order to run this scripts from the web, you should copy it to the web root.
