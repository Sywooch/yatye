    ...
    <div class="col-sm-8 col-lg-9">
        <div class="content">
            ...
            <div class="posts post-detail">
                ...
                <?php if ($model->image != ''): ?>
                    <img src="<?php echo Yii::$app->params['post_images'] . $model->image; ?>"
                ...
                <div class="post-meta clearfix div">
                    <div class="post-meta-date"><i
                                class="fa fa-clock-o"></i><?php echo date('D d M, Y', strtotime($model->getUpdatedAt())); ?>
                    </div>
                    <div class="post-meta-categories"><i class="fa fa-tags"></i> <a
                                href="<?php echo Yii::$app->request->baseUrl . '/post-category/' . $post_category->slug; ?>"><?php echo $post_category->name; ?></a>
                    </div>
