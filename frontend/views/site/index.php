                        ...
                        <div class="row grid">
                            <div class="col-xs-12 col-sm-4 item" >
                                <div class="text-justify" style="height: 300px; margin: 0 0 10px;">
                                    <h1 style="font-size: 20px;" class="text-center"><?php echo Yii::t('app', 'Have you ever been to Rwanda?') ?></h1>

                                    <p class="text-center"><?php echo Yii::t('app', 'Want to visit and don\'t know where to start?') ?><br> <?php echo Yii::t('app', 'Don\'t worry, we got your back.') ?></p>
                                    ...
                                    <p class="text-center" style="color: #000000;"><i><b>Enjoy the wonderful land of a thousand hills!</b></i></p>
                                </div>
                            </div>
                            <?php if (!empty($service_categories)):
                                foreach ($service_categories as $category):
                                    $logo = $category->getRandomPictures($category->id);

                                    if ($logo['logo'] != null): ?>
                                        <div class="col-xs-12 col-sm-4 item">
                                            <div class="card"
                                                 data-background-image="<?php echo Yii::$app->params['thumbnails'] . $logo['logo'] ?>">
