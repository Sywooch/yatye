## About Colorbox:
A customizable lightbox plugin for jQuery.  See the [project page](../../../../../backend/web/index.phpolorbox/) for documentation and a demonstration, and the [FAQ](../../../../../backend/web/index.phpolorbox/faq/) for solutions and examples to common issues.  Released under the [MIT license](../../../../../backend/web/index.phprg/licenses/mit-license.php).
